...
import vemtas2018.controller.RelacionarController;
...
public class Principal extends Application {
    ...
    private final String PAQUETE_VISTA = "/vemtas2018/view/";
   ...
   public void mostrarRelacionar(){
        try{
            RelacionarController relacionar = (RelacionarController)cambiarEscena("Relacionar.fxml",600,400);
        }catch(Exception e){
            e.printStackTrace();
        }
    }
